...
\begin{figure}[H]
	\begin{minipage}[t]{0.59\textwidth}
		\includegraphics[width=\linewidth]{MHSB_new}
	...
	\begin{minipage}[t]{0.39\textwidth}
		\includegraphics[width=0.95\linewidth]{Stimuli_cut}
		\captionsetup{width=0.9\linewidth}
...
\begin{figure}[H]
	\begin{minipage}[t]{0.49\textwidth}
		\centering
		\includegraphics[width=0.55\linewidth]{glove_markers}
		\captionsetup{width=0.9\linewidth}
	...
	\hspace{\fill}
	\begin{minipage}[t]{0.49\textwidth}
		\includegraphics[width=\linewidth]{Setting}
		\captionsetup{width=0.9\linewidth}
