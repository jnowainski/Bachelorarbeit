...
\usepackage{caption}
\usepackage{pdfpages}
%Define algorythm specific stuff here
...
\supervisor{Dr. Alexandra Moringen\\ Dr. Malte Schilling} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\department{Cluster of Excellence Cognitive Interaction Technology (CITEC)} % Your department's name and URL, this is used in the title page and abstract, print it elsewhere with \deptname
...
\faculty{\href{https://techfak.uni-bielefeld.de/en/faculty-technology}{Faculty of Technology}} % Your faculty's name and URL, this is used in the title page and abstract, print it elsewhere with \facname
...
{\scshape \facname\par}\vspace{1.5cm} % University name
...
\emph{}\\
\emph{\textbf{Study Program:}}\\
\href{}{Cognitive Computer Science}
\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.4\textwidth}
...
It was found that from the data models could be build to classify the objects that were explored and it was also possible to show that the same object yielded different data depending on its role as target or distractor in the experimental setting.  
...
\include{Chapters/2Experiment} 
\include{Chapters/3Data}
